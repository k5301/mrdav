...
public partial class AdmPerson : System.Web.UI.Page
{
    string pth;
    DataTable dt;
    Class1 obj;
    ...
    protected void btnUploadBannerImage_Click(object sender, EventArgs e)
    {
        ...
        if (txtHead.Text != "1" && txtHead.Text != "2" && txtHead.Text != "3")
        {
        ...
        if (txtHead.Text == "1")
        {
            lblBannerName.Text = "chairperson.jpg";
        }
        else if (txtHead.Text == "2")
        {
            lblBannerName.Text = "director.jpg";
        }
        else
        {
            lblBannerName.Text = "principal.jpg";
        }

        pth = "~//DynamicImages//ImageRecord//PersonImage//" + lblBannerName.Text;
