<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="AdmTopperStudents.aspx.cs" Inherits="AdmTopperStudents" %>
                	...
                	<div class="gallery">
                    	...
                    	<!-- Col1 -->
                        	<div class="categorydiv" style="margin:20px 15px 0 5px">
                            	<ul>
                                    <li><asp:LinkButton class="selected" ID="galleryRecord" runat="server" OnClick="galleryRecord_Click">Topper's Record</asp:LinkButton></li>
                                    ...
                                    <li><a href="AdmAlmuni.aspx">Almuni</a></li>
                                </ul>
                            </div>
                    		<div class="thumbdiv hideScrollbar" style="height:600px;overflow:scroll">    
                                <div style="text-align:justify">
                                    ...
                                    <div runat="server" visible="false" id="divAR">
                                        ...
                                        <asp:Button ID="btnUploadImage" CssClass="btn btn-primary" runat="server" Text="Add Record" OnClick="btnUploadImage_Click"/>
                                    ...
                                    <div runat="server" id="divTR">
                                        <div class="content_heading">
                                            <div class="heading" style="color:blue;font-weight:600;font-size:20px">Topper's Record</div>
                                        </div>
                                        <div>
                                                    ...
                                                    <li>
                                                        <a id="li" href='<%#Bind("limgPath") %>' runat="server" rel="galleryimg" class="galleryimg">
                                                            ...
                                                            <div style="float:left;width:216px">
                                                                ...
                                                                <asp:Label ID="lblImageTilte" style="color:black" runat="server" Text='<%#Bind("imageTitle") %>'></asp:Label>
