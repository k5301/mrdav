<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="AdmResults.aspx.cs" Inherits="AdmResults" %>
                    	...
                    	<!-- Col1 -->
                        	<div class="categorydiv" style="margin:20px 0 0 5px">
                            	<ul style="text-decoration:none">
                                    <li><asp:LinkButton class="selected" ID="resultsRecord" runat="server" OnClick="resultsRecord_Click">Results Record</asp:LinkButton></li>
                    		...
                    		<div class="thumbdiv hideScrollbar" style="height:720px;overflow:scroll;scroll-behavior:smooth;">
                                ...
                                <div style="text-align:justify">
                                    ...
                                    <div id="divDr" runat="server">
                                        <div class="content_heading">
                                            <div class="heading" style="color:blue;font-weight:600;font-size:20px">Results Record</div>
                                        </div>
                                        <p>
