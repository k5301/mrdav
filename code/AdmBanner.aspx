<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="AdmBanner.aspx.cs" Inherits="AdmBanner" %>
                                ...
                                <div style="text-align:justify">
                                    <div runat="server" id="divBanner">
                                        <div class="content_heading">
                                            <div class="heading" style="color:blue;font-weight:600;font-size:20px">Banner Images</div>
                                        </div>
                                        <br />
                                        <div id="banner">
                                            <div id="slider2">
                                                <div class="contentdiv">
                                                    <a href="#"><img style="width:710px;height:320px" src="DynamicImages/ImageRecord/BannerImage/BannerImage1.jpg" alt="" /></a>
                                                </div> 
                                                <div class="contentdiv">
                                                    <a href="#"><img style="width:710px;height:320px" src="DynamicImages/ImageRecord/BannerImage/BannerImage2.jpg" alt="" /></a>
                                                </div> 
                                                <div class="contentdiv">
                                                    <a href="#"><img style="width:710px;height:320px" src="DynamicImages/ImageRecord/BannerImage/BannerImage3.jpg" alt="" /></a>
                                                </div> 
                                                <div class="contentdiv">
                                                    <a href="#"><img style="width:710px;height:320px" src="DynamicImages/ImageRecord/BannerImage/BannerImage4.jpg" alt="" /></a>
                                                </div> 
                                                <div class="contentdiv">
                                                    <a href="#"><img style="width:710px;height:320px" src="DynamicImages/ImageRecord/BannerImage/BannerImage5.jpg" alt="" /></a>
                                                    <%--<a href="#"><img src="images/banner452.GIF" alt="" /></a>--%>
                                                </div> 
                                            </div> 
                                    ...
                                    <div runat="server" id="ui">
                                        ...
                                        <div>
                                            ...
                                            Banner Image: (Dimensions: 710*320 &nbsp; &nbsp; Format: only JPG)
                                            <br />
                                            ...
                                            <div id="divImageBanner" runat="server" visible="false" style="width:100%;height:auto">
                                                ...
                                                <asp:Image ID="bImg" runat="server" style="width:710px;height:320px;float:left;margin-bottom:15px"/>
                                                <br />
