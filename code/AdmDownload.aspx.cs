...
public partial class AdmDownload : System.Web.UI.Page
{
    string pth;
    DataTable dt;
    Class1 obj;
    ...
    protected void downloadsRecord_Click(object sender, EventArgs e)
    {
        divDr.Visible = true;
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        pth = "~//DownloadableFiles//UploadedFiles//ForDownloads//" + var + FileUpload1.FileName;
        ...
        obj.queryWithOutProcedure("insert into tbDownloadableFiles values('" + lblIconPath.Text + "','" + txtDescription.Text + "','" + lblpth.Text + "','" + dtime + "','1')");
        lblIconPath.Text = "";
        txtDescription.Text = "";
        lblpth.Text = "";
        databindrptFiles();
