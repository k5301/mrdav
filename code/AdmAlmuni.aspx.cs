...
public partial class AdmAlmuni : System.Web.UI.Page
{
    string pth;
    DataTable dt;
    Class1 obj;
    ...
    {
        dt = obj.showWithOutProcedure("select simgPath,limgPath,imageTitle,imageName from tbGalleryImageRecord where cid='-2' order by imgId desc");
    ...
    public void databindImageRecord()
    {
        ...
        dt = obj.showWithOutProcedure("select imgId,simgPath,limgPath,imageTitle,imageName from tbGalleryImageRecord where cid='-2' order by imgId desc");
    ...
    protected void btnUploadImage_Click(object sender, EventArgs e)
    {
        ...
        obj.queryWithOutProcedure("insert into tbGalleryImageRecord values('" + lblpthS.Text + "','" + lblpthL.Text + "','-2','" + txtImgTitle.Text + "','" + txtName.Text + "')");
        lblpthL.Text = "";
        lblpthS.Text = "";
        txtImgTitle.Text = "";
        divImageL.Visible = false;
