...
public partial class AdmNotice : System.Web.UI.Page
{
    string pth;
    DataTable dt;
    Class1 obj;
    ...
    {
        dt = obj.showWithOutProcedure("select * from tbNewsRecord where type='3'  order by nid desc");
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        obj.queryWithOutProcedure("insert into tbNewsRecord values('" + txtHead.Text + "','" + txtNewsDetail.Text + "','" + pth + "','3')");
        txtHead.Text = "";
        txtNewsDetail.Text = "";
        databindNewsRecord();
    }
