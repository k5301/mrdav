<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="AdmEvents.aspx.cs" Inherits="AdmEvents" %>
                    	...
                    	<!-- Col1 -->
                        	<div class="categorydiv" style="margin:20px 15px 0 5px">
                            	<ul style="text-decoration:none">
                                    <li><asp:LinkButton class="selected" ID="newsRecord" runat="server" OnClick="newsRecord_Click">Events Record</asp:LinkButton></li>
                                    <li><asp:LinkButton ID="uploadNews" runat="server" OnClick="uploadNews_Click">Upload Event</asp:LinkButton></li>
                                    <li><asp:LinkButton ID="deleteNews" runat="server" OnClick="deleteNews_Click">Delete Event</asp:LinkButton></li>
                                    <li><asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Update News</asp:LinkButton></li>
                                    <li><asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">Update Notice</asp:LinkButton></li>
                                </ul>
                            </div>
                                ...
                                <div style="text-align:justify">
                                   <div id="un" runat="server" visible="false">
                                        ...
                                        <p>
                                            ...
                                            <asp:Button ID="btnUpload" CssClass="btn btn-primary" runat="server" Text="Upload Event" OnClick="btnUpload_Click"/>
                                            <hr>
                                        </p>
                                    </div>
                                     ...
                                     <div id="nr">
                                        <div class="content_heading">
                                            <div class="heading" style="color:blue;font-weight:600;font-size:20px">Events Record</div>
                                        </div>
