<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="AdmNews.aspx.cs" Inherits="AdmNews" %>
                    	...
                    	<!-- Col1 -->
                        	<div class="categorydiv" style="margin:20px 15px 0 5px">
                            	<ul style="text-decoration:none">
                                    <li><asp:LinkButton class="selected" ID="newsRecord" runat="server" OnClick="newsRecord_Click">News Record</asp:LinkButton></li>
                                    <li><asp:LinkButton ID="uploadNews" runat="server" OnClick="uploadNews_Click">Upload News</asp:LinkButton></li>
                                    <li><asp:LinkButton ID="deleteNews" runat="server" OnClick="deleteNews_Click">Delete News</asp:LinkButton></li>
                                ...
                                <div style="text-align:justify">
                                    <div id="un" runat="server" visible="false">
                                        ...
                                        <p>
                                            ...
                                            <asp:Button ID="btnUpload" CssClass="btn btn-primary" runat="server" Text="Upload News" OnClick="btnUpload_Click"/>
                                            <hr>
                                        </p>
                                    </div>
                                    ...
                                    <div id="nr">
                                        <div class="content_heading">
                                            <div class="heading" style="color:blue;font-weight:600;font-size:20px">News Record</div>
                                        </div>
