...
public partial class AdmFacilities : System.Web.UI.Page
{
    string pth;
    DataTable dt;
    Class1 obj;
    ...
    protected void btnUploadBannerImage_Click(object sender, EventArgs e)
    {
        ...
        if (txtHead.Text != "1" && txtHead.Text != "2" && txtHead.Text != "3" && txtHead.Text != "4" && txtHead.Text != "5" && txtHead.Text != "6" && txtHead.Text != "7")
        {
        ...
        lblBannerName.Text = "Facilities" + txtHead.Text + ".jpg";
        pth = "~//DynamicImages//ImageRecord//FacilitiesImage//" + lblBannerName.Text;
